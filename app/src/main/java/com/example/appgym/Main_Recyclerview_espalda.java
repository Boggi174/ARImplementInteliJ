...
public class Main_Recyclerview_espalda extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.recycler_view,new recfragment_espalda()).commit();
